	...
	<div class = "container">
		<div class = "jumbotron">
			<div class = "container">
				<h1>웹 사이트 소개</h1>
				<p>
				이 사이트는 부트스트랩으로 만든 JSP 웹 사이트입니다. 최소한의 간단한 로직만을 이용해서 개발하였습니다.
	...
	<div class = "container">
		<div id = "myCarousel" class = "carousel slide">
			<ol class = "carousel-indicators">
				...
				<li data-target = "#myCarousel" data-slide-to = "2" class = "active">2</li>
				<li data-target = "#myCarousel" data-slide-to = "3" class = "active">3</li>
			</ol>
			<div class = "carousel-indicators">
				<div class = "item actvie">
					<img src = "img/1.jpg">
				</div>
				<div class = "item">
					<img src = "img/2.jpg">
