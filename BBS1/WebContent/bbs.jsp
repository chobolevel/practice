	...
	<div class = "container">
		<div class = "row">
			<table class = "table table-striped" style = "text-align : center; border : 1px solid #dddddd;">
				...
				<%
					...
					for(Bbs bbs : list) {
						...
						<tr>
							<td><%=bbsID %></td>
							<td><a href = "view.jsp?bbsID=<%=bbsID %>"><%= bbsTitle %></a></td>
							<td><%=bbsUserID %></td>
							<td><%=bbsDate.substring(0, 11) + bbsDate.substring(11, 13) + "시 " + bbsDate.substring(14, 16) + "분" %></td>
						</tr>
						<%
					}
				%>
			...
			<%
				...
				if(bbsDAO.nextPage(pageNumber + 1) == true) {
					%>
